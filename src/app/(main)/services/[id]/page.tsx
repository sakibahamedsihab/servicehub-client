...
import { ServiceDetailsAnimator } from "@/components/services/ServiceDetailsAnimator";
...
export default async function ServiceDetailsPage({ params }: Props) {
  ...
  return (
    <main className="pt-16 min-h-screen bg-gray-50 pb-16">
      <ServiceDetailsAnimator>
        {/* Header Banner */}
        <div className="bg-gray-900 py-12 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="hero-element inline-block bg-orange-500 text-white px-3 py-1 text-xs font-bold uppercase tracking-widest mb-4">
              {service.categoryId}
            </div>
            <h1 className="hero-element text-3xl md:text-5xl font-extrabold text-white m-0 mb-4 tracking-tight leading-tight">
              {service.title}
            </h1>
            <div className="hero-element flex items-center gap-4 flex-wrap">
        ...
        <div className="main-content max-w-7xl mx-auto px-6 py-12">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="flex flex-col gap-8 flex-1 w-full lg:w-2/3">
              ...
              <div className="content-block border-2 border-gray-200 bg-white p-2 parallax-container overflow-hidden">
                <div className="h-[300px] md:h-[400px] bg-gradient-to-br from-orange-100 to-gray-100 relative">
                  {service.images?.[0] ? (
                    <img src={service.images[0]} alt="Primary" className="parallax-img w-full h-full object-cover origin-center" style={{ transform: "scale(1.1)" }} />
                  ) : (
              ...
              {/* Description */}
              <div className="content-block bg-white border-2 border-gray-200 p-6 md:p-8 glow-card">
            ...
            <div className="booking-sidebar sticky top-24 w-full lg:w-1/3 shrink-0">
              <div className="bg-white border-2 border-gray-200 p-6 md:p-8 shadow-sm glow-card">
